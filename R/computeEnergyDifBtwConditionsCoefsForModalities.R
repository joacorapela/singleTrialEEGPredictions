...
computeEnergyDifBtwConditionsCoefsForModalities <- 
 function(sortvar, modalities, clustersIDs, condition1, condition2, 
    ...
    for(modality in modalities) {
        ...
        res <- 
         computeEnergyDifBtwConditionsCoefsForClusters(
          sortvar=sortvar,
          modality=modality,
...
computeEnergyDifBtwConditionsCoefsForClusters <- 
 function(sortvar, modality, clustersIDs, condition1, condition2,
    ...
    for(clusterID in clustersIDs) {
        ...
        res <- 
         computeEnergyDifBtwConditionsCoefsForSubjectsAndComponents(
          sortvar=sortvar,
          modality=modality,
          clusterID=clusterID,
          condition1=condition1,
 ...
 function(sortvar, modality, clusterID, condition1, condition2, 
    ...
    for(i in 1:nrow(subjectsAndComponents)) {
        ...
        show(sprintf("Processing subject %s and component %02d", subjectName,
                     component))
         res <- 
          computeEnergyDifBtwConditionsCoefsForSubjectAndComponent(
           sortvar=sortvar,
           modality=modality,
           clusterID=clusterID,
           condition1=condition1,
